...
const Home = () => {
	return (
		<>
			<div
				className='bg-cover bg-no-repeat bg-center py-52'
				style={{ backgroundImage: `url(${BannerBg})` }}
			>
				<div className='container mx-auto px-3 lg:px-0'>
					<h1 className='text-4xl lg:text-6xl text-gray-800 font-medium mb-4 capitalize'>
					...
					<div className='mt-12 max-w-[180px]'>
